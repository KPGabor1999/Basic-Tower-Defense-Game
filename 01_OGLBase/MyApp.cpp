...
void CMyApp::InitMeshes() {
	meshes[ENEMY]           = new MeshObject("assets/Enemy.obj", "assets/Enemy.png", "shaders/Enemy.vert", "shaders/Enemy.frag");
	meshes[CHEAPTOWER]      = new MeshObject("assets/CheapTower.obj", "assets/CheapTower.png", "shaders/Tower.vert", "shaders/Tower.frag");
	meshes[FASTRELOADTOWER] = new MeshObject("assets/FastReloadTower.obj", "assets/FastReloadTower.png", "shaders/Tower.vert", "shaders/Tower.frag");
	meshes[STRONGTOWER]     = new MeshObject("assets/StrongTower.obj", "assets/StrongTower.png", "shaders/Tower.vert", "shaders/Tower.frag");
	meshes[ROADBLOCK]       = new MeshObject("assets/Roadblock.obj", "assets/Roadblock.png", "shaders/Roadblock.vert", "shaders/Roadblock.frag");
	meshes[CANNONBALL]      = new MeshObject("assets/CannonBall.obj", "assets/CannonBall.png", "shaders/CannonBall.vert", "shaders/CannonBall.frag");
}
