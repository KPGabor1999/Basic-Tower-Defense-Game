...
protected:
	...
	//Hangfájlok:
	//enum SoundId {BACKGROUND_MUSIC, CONSTRUCTION_SOUND, UPGRADE_SOUND, CANNON_FIRE_SOUND, DEATHSCREAM_SOUND, ENEMY_PASSING_SOUND_1, ENEMY_PASSING_SOUND_2, GAME_OVER_SOUND};
	//std::map<SoundId, Mix_Music*> sounds;
